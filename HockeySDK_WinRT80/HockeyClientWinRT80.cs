...
namespace HockeyApp
{
    public class HockeyClientWinRT80
    {
        private ILog logger = HockeyLogManager.GetLog(typeof(HockeyClientWinRT80));

        private static readonly HockeyClientWinRT80 _instance = new HockeyClientWinRT80();
        public static HockeyClientWinRT80 Instance { get { return _instance; } }
