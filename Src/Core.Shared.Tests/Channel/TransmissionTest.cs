// Commenting out the code: UWP uses HttpClient, but for HttpClient nothing is done to intercept the requests.
...
//            // UWP uses HttpClient and there is no dependency injection done for HttpClient to intercept web requests.
//            [Ignore]
//            [TestMethod]
...
//                : base(
//                    endpointAddress ?? new Uri("http://test.uri"), // http://httpbin.org/post
//                    content ?? new byte[1],
