...
//            this.tags.InitializeTagValue(ContextTagKeys.Keys.DeviceOS, WindowsStoreSystemInfo.GetOperatingSystemName());
//            this.tags.InitializeTagValue(ContextTagKeys.Keys.DeviceOSVersion, source.OperatingSystemVersion);
