...
## Getting started 
1. <pre>Nuget PM> Install-Package HockeySDK.UWP</pre>
...
1. Run https://mseng.visualstudio.com/DefaultCollection/AppInsights/_build#favDefinitionId=2560&_a=completed in order to create signed binaries.
